...
<template>
    ...
    <div class="topo">
        ...
        <div class="text">
            ...
            <ul>
                <li>aux fortes compétences de ACG Cybersecurity en ingénierie des Réseaux, Sécurité.</li>
                <li>à une offre de services complète et intégrée, couvrant l’audit, le conseil, le déploiement, le support, la maintenance et l’exploitation de la solution.</li>
                <li>à un investissement permanent dans les nouveaux domaines technologiques</li>
                <li>à des partenariats très étroits avec les principaux leaders du marché, constructeurs d’équipement de réseaux et éditeurs de logiciels</li>
            </ul>
        </div>
    </div>
</template>
